...
import com.app.barbershopweb.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> onValidationException(ValidationException e) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorDto(e.getMessages()));
    }

    @ExceptionHandler(MailException.class)
    public ResponseEntity<ErrorDto> onMailException(MailException e) {
