...
public class BarbershopClosureService {
    ...
    public void outOfBusiness(Long barbershopId) {
        Barbershop barbershop = barbershopRepository.findBarbershopById(barbershopId).orElseThrow(() ->
        ...
        List<Users> victims = barbershopClosureRepository.getBarbershopVictimCustomers(barbershopId);
        ...
        mailService.notifyAboutOutOfBusiness(victims, barbershop.getEmail());
    }
}
