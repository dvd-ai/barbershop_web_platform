...
import static com.app.barbershopweb.barbershop.constants.BarbershopDto__TestConstants.BARBERSHOP_VALID_UPDATED_DTO;
...
class BarbershopIT extends AbstractIT {
    ...
    void shouldDeleteBarbershopById() {
        ResponseEntity<Object> response = restTemplate.exchange(
                BARBERSHOPS_URL + "/" + BARBERSHOP_VALID_BARBERSHOP_ID,
