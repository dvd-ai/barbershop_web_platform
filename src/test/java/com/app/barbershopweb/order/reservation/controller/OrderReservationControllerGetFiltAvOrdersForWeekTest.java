...
@DisplayName("TESTING: " + ORDER_RESERV_URL + " (getBarbershopActiveFilteredUnreservedOrdersForWeek method)")
class OrderReservationControllerGetFiltAvOrdersForWeekTest {
    ...
    void shouldReturnEmptyUnreservedOrdersList() throws Exception {
        ...
        when(orderReservationService.getFilteredAvailableOrders(any(), any(), any()))
    ...
    void shouldReturnFilteredUnreservedOrdersList() throws Exception {
        json = objectMapper.writeValueAsString(
                ortc.SUOR_DTO_WITH_FILTERS
        );

        when(orderReservationService.getFilteredAvailableOrders(any(), any(), any()))
                .thenReturn(ortc.UNRESERVED_FILTERED_ORDER_ENTITY_LIST);
        when(orderConverter.orderEntityListToDtoList(any()))
                .thenReturn(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST);
        ...
        mockMvc.perform(post(ORDER_RESERV_URL)
                ...
                .andExpect(jsonPath("$[0].orderId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).orderId().intValue())))
                .andExpect(jsonPath("$[0].barbershopId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).barbershopId().intValue())))
                .andExpect(jsonPath("$[0].barberId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).barberId().intValue())))
                .andExpect(jsonPath("$[0].customerId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).customerId())))
                .andExpect(jsonPath("$[0].orderDate", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).orderDate().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME))))
                .andExpect(jsonPath("$[0].active", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(0).active())))

                .andExpect(jsonPath("$[1].orderId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).orderId().intValue())))
                .andExpect(jsonPath("$[1].barbershopId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).barbershopId().intValue())))
                .andExpect(jsonPath("$[1].barberId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).barberId().intValue())))
                .andExpect(jsonPath("$[1].customerId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).customerId())))
                .andExpect(jsonPath("$[1].orderDate", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).orderDate().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME))))
                .andExpect(jsonPath("$[1].active", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(1).active())))

                .andExpect(jsonPath("$[2].orderId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).orderId().intValue())))
                .andExpect(jsonPath("$[2].barbershopId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).barbershopId().intValue())))
                .andExpect(jsonPath("$[2].barberId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).barberId().intValue())))
                .andExpect(jsonPath("$[2].customerId", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).customerId())))
                .andExpect(jsonPath("$[2].orderDate", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).orderDate().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME))))
                .andExpect(jsonPath("$[2].active", is(ortc.UNRESERVED_FILTERED_ORDER_DTO_LIST.get(2).active())))
